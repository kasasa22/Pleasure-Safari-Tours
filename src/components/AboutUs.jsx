        ...
        <div className="row g-5 align-items-center">
          <div className="col-lg-5">
            <div className="h-100" style={{ border: '50px solid', borderColor: 'transparent #13357B transparent #13357B' }}>
              <img src={aboutImg} className="img-fluid w-100 h-100" alt="About Us" />
            </div>
          </div>
          <div className="col-lg-7" style={{ background: `linear-gradient(rgba(255, 255, 255, .8), rgba(255, 255, 255, .8)), url(${aboutImg1})` }}>
